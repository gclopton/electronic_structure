...
## 9.1.1 Ladder of functionals with increasing complexity and capability

## 9.1.2 Functionals of occupied/unoccupied states <br> Random phase approx., ...Section 9.7

## 9.1.3 Functionals of occupied states Hybrids, SIC, DFT+U, ...Sections 9.2-9.6
...
## 9.3.1 Variation of the Long-Range Exchange Hybrid Functionals
...
## 9.3.2 Range-Separated Hybrid Functionals
...
## 9.3.3 Short-Range-Only Functionals
...
## 9.3.4 Range Separation with Screened Long-Range Exchange
...
## 9.3.5 Nonempirical Hybrid Functionals
...
## 9.4.1 The SCAN Meta-GGA Functional
...
## 9.5.1 Slater Local Approximation for Exchange
...
## 9.6.1 Self-Interaction Correction (SIC)
...
## 9.6.2 Adding Hubbard-Like Interactions: DFT+U
...
## 9.6.3 Generalized Koopmans' Functionals
...
## 9.8.1 Pair-Wise Additive Contributions to the Energy
...
## 9.8.2 Functionals Based on Theories of Nonlocal Correlation
...
## 9.10.1 One-Electron Problems: Hydrogen
...
## 9.10.3 Pointers to Places in This book with Comparisons of Functionals for Solids
